...
public class EntityVillagerGolem extends class_vg {
	...
	public EntityVillagerGolem(class_ago var1) {
		super(var1);
		this.a(1.4F, 2.9F);
		((class_ul) u()).a(true);
		...
		bo.a(3, new EntityVillagerGolem.class_a_in_class_vp(this, EntityInsentient.class, 10, false, true, class_xx.e));
	}
	...
	protected void s(Entity var1) {
		if ((var1 instanceof class_xx) && !(var1 instanceof EntityCreeper) && (bj().nextInt(20) == 0)) {
			this.c((EntityLiving) var1);
		}
	...
	public boolean a(Class var1) {
		return cG() && class_yu.class.isAssignableFrom(var1) ? true : (var1 == EntityCreeper.class ? true : super.a(var1));
	}
	...
	static {
		a = DataWatcher.claimId(EntityVillagerGolem.class, class_kb.a);
	}

	static class class_a_in_class_vp extends class_uf {
		public class_a_in_class_vp(final EntityCreature var1, Class var2, int var3, boolean var4, boolean var5, final Predicate var6) {
