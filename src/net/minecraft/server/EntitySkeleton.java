...
public class EntitySkeleton extends EntityMonster implements class_ye {
	...
	public EntitySkeleton(class_ago var1) {
		super(var1);
		i.a(1, new class_so(this));
		i.a(2, new class_tr(this));
		i.a(3, new class_sn(this, 1.0D));
		i.a(3, new class_sg(this, EntityWolf.class, 6.0F, 1.0D, 1.2D));
	...
	public boolean r(Entity var1) {
		if (super.r(var1)) {
			if ((cF() == 1) && (var1 instanceof EntityLiving)) {
				((EntityLiving) var1).c(new class_qr(class_qs.t, 200));
			}
	...
	public void an() {
		super.an();
		if (m instanceof EntityCreature) {
			EntityCreature var1 = (EntityCreature) m;
			aM = var1.aM;
		}
	...
	public void a(class_qi var1) {
		super.a(var1);
		if ((var1.i() instanceof EntityArrow) && (var1.j() instanceof class_yu)) {
		...
		} else if ((var1.j() instanceof EntityCreeper) && ((EntityCreeper) var1.j()).n() && ((EntityCreeper) var1.j()).cI()) {
	...
	public void a(EntityLiving var1, float var2) {
		EntityArrow var3 = new EntityArrow(o, this);
	...
	static {
		a = DataWatcher.claimId(EntitySkeleton.class, class_kb.b);
		b = DataWatcher.claimId(EntitySkeleton.class, class_kb.g);
	}
}
